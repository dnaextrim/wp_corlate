...
function insert_portfolio_button() {  
    ?>
    <a href="#" id="add-portfolio_button" class="button" data-read="<?php echo get_template_directory_uri() ?>/admin/get_portfolio.php"><i class="fa fa-desktop"></i> Add Portfolio</a>
    <?php
}
