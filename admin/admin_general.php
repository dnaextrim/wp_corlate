...
function display_contact_support_element() {
    ?>
        <input type="text" name="wp_corlate_contact_support" id="wp_corlate_contact_support" class="form-control col-sm-6 col-xs-12" value="<?php echo get_option('wp_corlate_contact_support'); ?>" placeholder="Contact Phone/Email" />
    <?php
}

function display_twitter_element() {
    ?>
        <input type="url" name="wp_corlate_twitter_url" id="wp_corlate_twitter_url" class="form-control col-sm-6 col-xs-12" value="<?php echo get_option('wp_corlate_twitter_url'); ?>" />
    <?php
}

function display_facebook_element() {
    ?>
        <input type="url" name="wp_corlate_facebook_url" id="wp_corlate_facebook_url" class="form-control col-sm-6 col-xs-12" value="<?php echo get_option('wp_corlate_facebook_url'); ?>" />
    <?php
}

function display_github_element() {
    ?>
        <input type="url" name="wp_corlate_github_url" id="wp_corlate_github_url" class="form-control col-sm-6 col-xs-12" value="<?php echo get_option('wp_corlate_github_url'); ?>" />
    <?php
}
