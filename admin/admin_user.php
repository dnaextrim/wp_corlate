    ...
    ?>
        ...
        <table class="form-table">
            <tr>
                ...
                <td><input type="text" name="facebook" value="<?php echo esc_attr(get_the_author_meta( 'wp_corlate_facebook', $user->ID )); ?>" class="regular-text" /></td>
            </tr>

            <tr>
                <th><label for="twitter">Twitter Url</label></th>
                <td><input type="text" name="twitter" value="<?php echo esc_attr(get_the_author_meta( 'wp_corlate_twitter', $user->ID )); ?>" class="regular-text" /></td>
            </tr>

            <tr>
                <th><label for="gplus">Google+ Url</label></th>
                <td><input type="text" name="gplus" value="<?php echo esc_attr(get_the_author_meta( 'wp_corlate_gplus', $user->ID )); ?>" class="regular-text" /></td>
            </tr>
            <tr>
                <th><label for="github">Github Url</label></th>
                <td><input type="text" name="github" value="<?php echo esc_attr(get_the_author_meta( 'wp_corlate_github', $user->ID )); ?>" class="regular-text" /></td>
            </tr>
        </table>
    <?php
}
