...
function theme_settings_footer_links() {
    ...
    ?>
        ...
        <div class="wrap">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <button id="btn_delete_group" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i> Delete</button>
                </div>
            </div>
            <h3>
                Footer Links List
            ...
            <div class="table-responsive">
                <table id="list_footer_links" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                    <thead>
                        <tr>
        ...
        <div id="form_group_footer_links" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">       
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="form-group-footer-links" method="post" action="<?php echo get_template_directory_uri() ?>/admin/footer_links/action_add_group.php">
                            ...
                            <div class="wrap">
                                ...
                                <table class="form-table">
                                    <tr>
                                        ...
                                        <td><input type="text" name="group_name" id="group_name" value="" class="regular-text" required /></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
        ...
        <div id="form_footer_links" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">       
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="form-footer-links" method="post" action="<?php echo get_template_directory_uri() ?>/admin/footer_links/action_add_links.php">
                        <div class="modal-body">
                            <div class="wrap">
                                <?php
                                    // settings_fields("section-footer_links-form");
                                ...
                                <table class="form-table">
                                    <tr>
                                        ...
                                        <td><input type="text" name="title_links" id="title_links" value="" class="regular-text" required /></td>
                                    </tr>
                                    <tr>
                                        <th><label for="link_links">Link</label></th>
                                        <td><input type="url" name="link_links" id="link_links" value="" class="regular-text" required /></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
