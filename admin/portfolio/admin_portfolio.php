...
function theme_settings_portfolio() {
    ?>
        ...
        <div id="box_portfolio">
            <div class="wrap">
                ...
                <div class="table-responsive">
                    <table id="list_portfolio" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                        <thead>
                            <tr>
        ...
        <div id="form_portfolio" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">       
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="form-portfolio" method="post" action="<?php echo get_template_directory_uri() ?>/admin/slider/action_add_portfolio.php" enctype="multipart/form-data">
        ...
        <div id="box_portfolio_project" style="display: none">
            ...
            <div class="wrap">
                <button type="button" id="btn_back_project" class="btn btn-primary"><i class="fa fa-backward"></i> Back to Portfolio</button>    
                <h3>
                    <h1 id="portfolio_name"></h1>
                    Portfolio Project List
                    <button id="btn_add_new_project" class="btn btn-success pull-right" style="margin-right: 6px;"><i class="fa fa-plus"></i> Add New</button>
                </h3>
                <hr />
                <div class="table-responsive">
                    <table id="list_portfolio_project" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th width="80px">Action</th>
                                <th width="30px">ID</th>
        ...
        <div id="form_portfolio_project" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">       
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="form-portfolio-project" method="post" action="<?php echo get_template_directory_uri() ?>/admin/portfolio/action_add_portfolio_project.php" enctype="multipart/form-data">
                            ...
                            <div class="wrap">
                                ...
                                <table class="form-table">
                                    <tr>
                                        ...
                                        <td><input type="text" name="name_project" id="name_project" value="" class="regular-text" required /></td>
                                    </tr>
                                    
                                    <tr>
                                        <th><label for="image_url_project">Cover Image</label></th>
                                        <td>
                                            <input type="file" name="image_url_project" id="image_url_project" required accept="image/gif,image/jpeg,image/png" />
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="url" name="project_url_project" id="project_url_project" value="" class="regular-text" required /></td>
                                    </tr>
                                    
                                    <tr>
                                        <th><label for="category_project">Category</label></th>
                                        <td><input type="text" name="category_project" id="category_project" value="" class="regular-text" required /></td>
                                    </tr>

                                    <tr>
                                        <th><label for="open_new_tab_project">Open New Tab</label></th>
                                        <td><input type="checkbox" name="open_new_tab_project" id="open_new_tab_project" value="true" /></td>
                                    </tr>

                                    <tr>
                                        <th><label for="published_project">Published</label></th>
                                        <td><input type="checkbox" name="published_project" id="published_project" value="true" /></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
        ...
        <div id="box_portfolio_images" style="display: none">
            ...
            <div class="wrap">
                <button type="button" id="btn_back_images" class="btn btn-primary"><i class="fa fa-backward"></i> Back to Project</button>    
                <h3>
                    <h1 id="project_name"></h1>
                    Portfolio Images List
                    <button id="btn_add_new_images" class="btn btn-success pull-right" style="margin-right: 6px;"><i class="fa fa-plus"></i> Add New</button>
                </h3>
                <hr />
                <div class="table-responsive">
                    <table id="list_portfolio_images" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th width="80px">Action</th>
                                <th width="30px">ID</th>
        ...
        <div id="form_portfolio_images" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">       
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="form-portfolio-images" method="post" action="<?php echo get_template_directory_uri() ?>/admin/portfolio/action_add_portfolio_images.php" enctype="multipart/form-data">
                        <div class="modal-body" style="height: 400px; overflow-y: auto;">
                            <div class="wrap">
                                <?php
                                    // settings_fields("section-portfolio-form");
                                ...
                                <table class="form-table">
                                    <tr>
                                        ...
                                        <td><input type="text" name="name_images" id="name_images" value="" class="regular-text" required /></td>
                                    </tr>
                                    
                                    <tr>
                                        <th><label for="image_url_images">Image</label></th>
                                        <td>
                                            <input type="file" name="image_url_images" id="image_url_images" required accept="image/gif,image/jpeg,image/png" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="description_images" id="description_images" class="regular-text" />
                                        </td>
                                    </tr>
                                    
                                    <tr>
                                        <th><label for="published_images">Published</label></th>
                                        <td><input type="checkbox" name="published_images" id="published_images" value="true" /></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
