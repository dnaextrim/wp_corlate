...
<div class="carousel slide">
    ...
    <div class="carousel-inner" style="height: 400px;">
        ...
        foreach($sliders as $key => $slider):
         ...
         ?>
        <div class="item <?php echo ($key == 0)?'active':'' ?>" class="animation" data-animation="<?php echo $slider['image1_animation'] ?>" data-duration="<?php echo $slider['image1_duration'] ?>" data-delay="<?php echo $slider['image1_delay'] ?>" style="background-image: url(<?php echo $slider['image1']; ?>)">
                ...
                <div class="row slide-margin" style="width: 100%">
                    <div class="col-sm-6">
                        <div class="carousel-content">
                            ...
                            ?>
                            <h1 style="font-size: 18px; color: #FFFFFF;" class="animation" data-animation="<?php echo $slider['title_animation'] ?>" data-duration="<?php echo $slider['title_duration'] ?>" data-delay="<?php echo $slider['title_delay'] ?>"><?php echo $slider['title'] ?></h1>
                            <?php
                            endif;
                            if (!empty($slider['sub_title'])):
                            ?>
                            <h2 style="font-size: 14px" class="animation" data-animation="<?php echo $slider['sub_title_animation'] ?>" data-duration="<?php echo $slider['sub_title_duration'] ?>" data-delay="<?php echo $slider['sub_title_delay'] ?>"><?php echo $slider['sub_title'] ?></h2>
                            <?php 
                            endif;
                            if (!empty($slider['read_more'])):
                            ?>
                            <a class="btn-slide animation" style="padding: 8px; font-size: 10px;" data-animation="<?php echo $slider['read_more_animation'] ?>" data-duration="<?php echo $slider['read_more_duration'] ?>" data-delay="<?php echo $slider['read_more_delay'] ?>" href="<?php echo $slider['read_more'] ?>">Read More</a>
                            <?php
                            endif
                            ?>
                        </div>
                    ...
                    <div class="col-sm-6 hidden-xs animation" data-animation="<?php echo $slider['image2_animation'] ?>" data-duration="<?php echo $slider['image2_duration'] ?>" data-delay="<?php echo $slider['image2_delay'] ?>">
                        <div class="slider-img col-sm-12">
                            <img src="<?php echo $slider['image2'] ?>" class="img-responsive pull-right" style="height: 300px;">
                        </div>
                    </div>
                </div>
            </div>
