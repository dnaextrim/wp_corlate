...
function theme_settings_slider() {
    ...
    ?>
        <div class="wrap">
            <div class="alert alert-success" role="alert">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation"><a href="#indonesian" aria-controls="indonesian" role="tab" data-toggle="tab">Indonesian</a></li>
                </ul>
                            ...
                            <div class="col-sm-10">
                                <p>
                                    <small>
                                        ...
                                        <strong>Corlate</strong> is a Free HTML template owned by <strong><a href="https://shapebootstrap.net/item/1524962-corlate-free-responsive-business-html-template" target="_blank">shapebootstrap</a>.</strong><br />
                                        <strong>WP Corlate</strong> is convertion result of <strong>Corlate</strong> HTML Template with some addtional fiture at Admin section and modification at portfolio section owned by <strong>Dony Wahyu Isp</strong> (<strong><a href="http://donywahyuisp.com" target="_blank">www.donywahyuisp.com</a></strong>)
                                    </small>
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <p>
                                    <small>
                                        ...
                                        and each time you donate you have the right to request one feature to the next updates, and
                                        The features of your request will be my immediate process to be realized.
                                    </small><br />
                                    <strong>Once you make a donation please confirm by sending a confirmation email with the title "Confirm Donation WP Corlate" to <a href="mailto:dna.extrim@gmail.com">dna.extrim@gmail.com</a></i></strong>
                                    <br />
                                    Thank you :-D
                                </p>
                            </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="indonesian">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <p>
                                    <small>
                                        <strong>WP Corlate</strong> Themes merupakan themes Wordpress <strong>Gratis.</strong><br />
                                        <strong>Corlate</strong> merupakan template HTML Gratis milik <strong><a href="https://shapebootstrap.net/item/1524962-corlate-free-responsive-business-html-template" target="_blank">shapebootstrap</a>.</strong><br />
                                        <strong>WP Corlate</strong> merupakan hasil konversi dari <strong>Corlate</strong> HTML Template dengan penambahan beberapa fitur pada bagian Admin dan modifikasi pada bagian portfolio milik <strong>Dony Wahyu Isp</strong> (<strong><a href="http://donywahyuisp.com" target="_blank">www.donywahyuisp.com</a></strong>)
                                    </small>
                                </p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p>
                                    <small>
                                        Donasi anda sangat saya perlukan untuk saya agar bisa tetap mengembangkan template ini, bagi anda 
                                        yang telah berdonasi saya akan kirimkan kepada anda Template ini yang didalamnya tidak terdapat
                                        pesan donasi seperti ini, dan saya akan selalu mengirimkan update dari template ini kepada anda, 
                                        dan setiap anda berdonasi anda berhak untuk meminta 1 fitur untuk update-update berikutnya, dan
                                        fitur permintaan anda tersebut akan segera saya proses untuk segera di realisasikan. 
                                    </small><br />
                                    <strong><i>Setelah anda melakukan donasi silakan anda melakukan konfirmasi dengan mengirimkan email konfirmasi dengan judul "Konfirmasi Donasi WP Corlate" ke <a href="mailto:dna.extrim@gmail.com">dna.extrim@gmail.com</a></i></strong>
                                    <br />
                                    Terima Kasih :-D
                                </p>
                            </div>
        ...
        <div class="wrap">
            <h3>
                Slider List
                <button id="btn_preview_slider" class="btn btn-primary pull-right"><i class="fa fa-play"></i> Preview Slider</button>
                <button id="btn_add_new" class="btn btn-success pull-right" style="margin-right: 6px;"><i class="fa fa-plus"></i> Add New</button>
            </h3>
            <hr />
        ...
        <div id="form_slider" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">       
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="form-slider" method="post" action="<?php echo get_template_directory_uri() ?>/admin/slider/action_add_slider.php" enctype="multipart/form-data">
                            ...
                            <div class="wrap">
                                ...
                                <table class="form-table">
                                    <tr>
                                        ...
                                        <td><input type="text" name="title" id="title" value="" class="regular-text" required /></td>
                                    </tr>
                                    
                                    <tr>
                                        <th><label for="sub_title">Sub Title</label></th>
                                        <td><input type="text" name="sub_title" id="sub_title" value="" class="regular-text" /></td>
                                    </tr>
                                    
                                    <tr>
                                        <th><label for="read_more">Read More</label></th>
                                        <td><input type="url" name="read_more" id="read_more" value="" class="regular-text" /></td>
                                    </tr>
                                    
                                    <tr>
                                        <th><label for="image1">Background</label></th>
                                        <td>
                                            <input type="file" name="image1" id="image1" required accept="image/gif,image/jpeg,image/png" />
                                            <div id="image_box1" class="col-xs-12 hidden" >
                                                <img id="image1" class="col-xs-12" src="" /><br />
                                                <button type="button" id="btn_delete_image1" class="btn btn-danger">Delete</button>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="file" name="image2" id="image2" accept="image/gif,image/jpeg,image/png" />
                                            <div id="image_box2" class="col-xs-12 hidden" >
                                                <img id="image2" class="col-xs-12" src="" /> <br />
                                                <button type="button" id="btn_delete_image2" class="btn btn-danger">Delete</button>
                                            </div>
                                        </td>
                                    </tr>
        ...
        <div id="form_animation" class="modal fade col-xs-12" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">       
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <form id="form-animation" method="post" action="<?php echo get_template_directory_uri() ?>/admin/slider/action_update_animation.php" enctype="multipart/form-data">
                        <div class="modal-body" style="height: 400px; overflow-y: auto;">
                            <div class="wrap">
                                <?php
                                    // settings_fields("section-slider-form");
                                ...
                                <table class="form-table table table-striped">
                                    <tr>
                                        <th>
                                            Title <button type="button" id="title_play" class="btn btn-primary btn-xs pull-right"><i class="fa fa-play"></i> Play</button><br />
                                            <br />
                                            <div class="well col-sm-12 col-xs-12 text-center" style="padding: 20px; overflow: hidden">
                                            ...
                                            <table class="table table-striped table-bordered">
                                                        ...
                                                        <select id="title_animation" name="title_animation">
                                                            ...
                                                            foreach ($animation as $key => $efek):
                                                                ...
                                                                <optgroup label="<?php echo $key ?>">
                                                                    ...
                                                                    ?>
                                                                    <option value="<?php echo $efek2 ?>" <?php if ($efek2 == 'fadeInUp') echo 'selected'; ?>><?php echo $efek2 ?></option>
                                                                    <?php endforeach?>
                                                                </optgroup>
                                                                <?php
                                                                else:
                                                            ?>
                                                                <option value="<?php echo $efek ?>"><?php echo $efek ?></option>
                                                            <?php 
                                                                endif;
                                                            endforeach ?>
                                                        </select>
                                                ...
                                                <tr>
                                                    <th>Duration</th>
                                                    <th><input type="number" id="title_duration" name="title_duration" size="30" value="300" />ms</th>
                                                </tr>
                                                <tr>
                                                    <th><label>Delay</label></th>
                                                    <th><input type="number" id="title_delay" name="title_delay" size="30" value="300" />ms</th>
                                                </tr>
                                            </table>
                                        </th>
                                    </tr>
                                    ...
                                    <tr>
                                        <th>
                                            Sub Title <button type="button" id="sub_title_play" class="btn btn-primary btn-xs pull-right"><i class="fa fa-play"></i> Play</button><br />
                                            <br />
                                            <div class="well col-sm-12 col-xs-12 text-center" style="padding: 20px; overflow: hidden">
                                            ...
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tr>
                                                    <th>Duration</th>
                                                    <th>
                                                        <input type="number" id="sub_title_duration" name="sub_title_duration" value="300" />ms&nbsp;&nbsp;
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th>Delay</th>
                                                    <th>
                                                        <input type="number" id="sub_title_delay" name="sub_title_delay" value="300" />ms&nbsp;&nbsp;
                                                    </th>
                                                </tr>
                                            </table>
                                        </th>
                                    ...
                                    <tr>
                                        <th>
                                            Read More <button type="button" id="read_more_play" class="btn btn-primary btn-xs pull-right"><i class="fa fa-play"></i> Play</button><br />
                                            <br />
                                            <div class="well col-sm-12 col-xs-12 text-center" style="padding: 20px; overflow: hidden">
                                                <a id="read_more_animation_preview" class="btn btn-danger animation">Read More</a>
                                            </div>
                                            <table class="table table-striped table-bordered">
                                                <tr>
                                                    <th>Animation</th>
                                                ...
                                                <tr>
                                                    <th>Duration</th>
                                                    <th><input type="number" id="read_more_duration" size="30" value="300" />ms</th>
                                                </tr>
                                                <tr>
                                                    <th><label>Delay</label></th>
                                                    <th><input type="number" id="read_more_delay" size="30" value="300" />ms</th>
                                                </tr>
                                            </table>
                                        </th>
                                    </tr>
                                    ...
                                    <tr>
                                        <th>
                                            Background <button type="button" id="image1_play" class="btn btn-primary btn-xs pull-right"><i class="fa fa-play"></i> Play</button><br />
                                            <br />
                                            <div class="well col-sm-12 col-xs-12 text-center" style="padding: 20px; overflow: hidden">
                                                <img id="image1_animation_preview" class="animation center-block" style="width:70%;" alt="Backround" />
                                            </div>
                                            <table class="table table-striped table-bordered">
                                                <tr>
                                                    <th>Animation</th>
                                                ...
                                                <tr>
                                                    <th>Duration</th>
                                                    <th>
                                                        <input type="number" id="image1_duration" name="image1_duration" value="300" />ms&nbsp;&nbsp;
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th>Delay</th>
                                                    <th>
                                                        <input type="number" id="image1_delay" name="image1_delay" value="300" />ms&nbsp;&nbsp;
                                                    </th>
                                                </tr>
                                            </table>
                                        </th>
                                    ...
                                    <tr>
                                        <th>
                                            Slider Image <button type="button" id="image2_play" class="btn btn-primary btn-xs pull-right"><i class="fa fa-play"></i> Play</button><br />
                                            <br />
                                            <div class="well col-sm-12 col-xs-12" style="padding: 20px; overflow: hidden">
                                                <img id="image2_animation_preview" class="animation center-block" style="width:20%;" alt="Slider Image" />
                                            </div>
                                            <table class="table table-striped table-bordered">
                                                <tr>
                                                    <th>Animation</th>
                                                ...
                                                <tr>
                                                    <th>Duration</th>
                                                    <th>
                                                        <input type="number" id="image2_duration" name="image2_duration" value="300" />ms&nbsp;&nbsp;
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th>Delay</th>
                                                    <th>
                                                        <input type="number" id="image2_delay" name="image2_delay" value="300" />ms&nbsp;&nbsp;
                                                    </th>
                                                </tr>
                                            </table>
                                        </th>
        ...
        <div id="loading" class="modal fade" data-backdrop="static" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
...
function display_enable_slider_element() {
    ?>
        <input type="checkbox" name="wp_corlate_enable_slider" class="form-control" value="1" <?php checked(1, get_option('wp_corlate_enable_slider'), true); ?> /> 
    <?php
}
...
function display_show_on_element() {
    ?>
        <select name="wp_corlate_slider_show_on">
            <option value="All" <?php echo (get_option('wp_corlate_slider_show_on') == 'All')? 'selected':''; ?>>All</option>
            <option value="Home Only" <?php echo (get_option('wp_corlate_slider_show_on') == 'Home Only')? 'selected':''; ?>>Home Only</option>
            <option value="All Post" <?php echo (get_option('wp_corlate_slider_show_on') == 'All Post')? 'selected':''; ?>>All Post</option>
            <option value="All Page" <?php echo (get_option('wp_corlate_slider_show_on') == 'All Page')? 'selected':''; ?>>All Page</option>
            <option value="All Category" <?php echo (get_option('wp_corlate_slider_show_on') == 'All Category')? 'selected':''; ?>>All Category</option>
            <option value="All Tag" <?php echo (get_option('wp_corlate_slider_show_on') == 'All Tag')? 'selected':''; ?>>All Tag</option>
        </select> 
    <?php
}
// End Fields
