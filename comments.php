...
<div id="contact-page clearfix">
    ...
    <form id="commentform" class="contact-form" novalidate name="contact-form" method="post" action="<?php echo esc_url(get_site_url().'/wp-comments-post.php') ?>">
        <div class="row">
            <div class="col-sm-5">
            ...
            <div class="col-sm-7"> 
                ...
                <div class="form-group">
                    <button type="submit" id="submit" name="submmit" class="btn btn-primary btn-lg" required="required">Post Comment</button>
