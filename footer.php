...
<footer id="footer" class="midnight-blue" style="margin-top:0px;">
	<div class="container">
		<div class="row">
			<div class="col-sm-6">
				&copy; 2015 <a target="_blank" href="<?php echo esc_url( __( 'https://donywahyuisp.com/', '_s' ) ); ?>"
				               title="<?php printf( esc_html__( 'Proudly powered by %s', '_s' ), 'WordPress' ); ?>">DonyWahyuIsp.com</a>.
				       Sponsored by <a href="www.ferenz.com.br">ferenz.com.br</a> All Rights Reserved.
			</div>
			<div class="col-sm-6">
				<ul class="pull-right">
