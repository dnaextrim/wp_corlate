            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-4">
                        ...
                        ?>
                        <div class="top-number"><p><i class="fa fa-phone-square"></i>  <?php echo $contact_support ?></p></div>
                        <?php endif ?>
                    </div>
                    ...
                    <div class="col-sm-6 col-xs-8">
                       <div class="social">
                            <ul class="social-share">
                                ...
                                if (!empty($github)) {
                                ?>
                                <li><a target="_blank" href="<?php echo $github ?>"><i class="fa fa-github"></i></a></li>
                                <?php
                                }
                                ?>
                            </ul>
                            <div class="search">
                                <form role="search" method="get" id="searchform" class="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                                    <input type="text" name="s" id="s" class="search-form" autocomplete="off" placeholder="Search">
